...
type AllTabsStatsPanelScope struct{}

func (o AllTabsStatsPanelScope) MarshalYAML() (interface{}, error) {
...
func (o *AllTabsStatsPanelScope) UnmarshalYAML(unmarshal func(interface{}) error) error {
...
type SelectedTabStatsPanelScope struct{}

func (o SelectedTabStatsPanelScope) MarshalYAML() (interface{}, error) {
	jsonBytes, err := safejson.Marshal(o)
	if err != nil {
		return nil, err
	}
...
func (o *SelectedTabStatsPanelScope) UnmarshalYAML(unmarshal func(interface{}) error) error {
	jsonBytes, err := safeyaml.UnmarshalerToJSONBytes(unmarshal)
	if err != nil {
		return err
	}
...
type WorkbookSettings struct {
	...
	*/
	...
	/*
	   Which panels the workbook's statistics table collects variables from.
	   When absent, the table shows only the variables plotted on the selected tab.
	*/
	StatsPanelScope *WorkbookStatsPanelScope `json:"statsPanelScope,omitempty"`
}

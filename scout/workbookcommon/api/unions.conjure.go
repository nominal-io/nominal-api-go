...
type WorkbookStatsPanelScope struct {
	typ         string
	selectedTab *SelectedTabStatsPanelScope
	allTabs     *AllTabsStatsPanelScope
}

type workbookStatsPanelScopeDeserializer struct {
	Type        string                      `json:"type"`
	SelectedTab *SelectedTabStatsPanelScope `json:"selectedTab"`
	AllTabs     *AllTabsStatsPanelScope     `json:"allTabs"`
}

func (u *workbookStatsPanelScopeDeserializer) toStruct() WorkbookStatsPanelScope {
	return WorkbookStatsPanelScope{typ: u.Type, selectedTab: u.SelectedTab, allTabs: u.AllTabs}
}

func (u *WorkbookStatsPanelScope) toSerializer() (interface{}, error) {
	switch u.typ {
	default:
		return nil, fmt.Errorf("unknown type %q", u.typ)
	case "selectedTab":
		if u.selectedTab == nil {
			return nil, fmt.Errorf("field \"selectedTab\" is required")
		}
		return struct {
			Type        string                     `json:"type"`
			SelectedTab SelectedTabStatsPanelScope `json:"selectedTab"`
		}{Type: "selectedTab", SelectedTab: *u.selectedTab}, nil
	case "allTabs":
		if u.allTabs == nil {
			return nil, fmt.Errorf("field \"allTabs\" is required")
		}
		return struct {
			Type    string                 `json:"type"`
			AllTabs AllTabsStatsPanelScope `json:"allTabs"`
		}{Type: "allTabs", AllTabs: *u.allTabs}, nil
	}
}

func (u WorkbookStatsPanelScope) MarshalJSON() ([]byte, error) {
	ser, err := u.toSerializer()
	if err != nil {
		return nil, err
	}
...
func (u *WorkbookStatsPanelScope) UnmarshalJSON(data []byte) error {
	var deser workbookStatsPanelScopeDeserializer
	if err := safejson.Unmarshal(data, &deser); err != nil {
		return err
	}
	*u = deser.toStruct()
	...
	case "selectedTab":
		if u.selectedTab == nil {
			return fmt.Errorf("field \"selectedTab\" is required")
		}
	case "allTabs":
		if u.allTabs == nil {
			return fmt.Errorf("field \"allTabs\" is required")
		}
	}
	return nil
}

func (u WorkbookStatsPanelScope) MarshalYAML() (interface{}, error) {
	jsonBytes, err := safejson.Marshal(u)
	if err != nil {
		return nil, err
	}
...
func (u *WorkbookStatsPanelScope) UnmarshalYAML(unmarshal func(interface{}) error) error {
	jsonBytes, err := safeyaml.UnmarshalerToJSONBytes(unmarshal)
	if err != nil {
		return err
	}
...
func (u *WorkbookStatsPanelScope) AcceptFuncs(selectedTabFunc func(SelectedTabStatsPanelScope) error, allTabsFunc func(AllTabsStatsPanelScope) error, unknownFunc func(string) error) error {
	switch u.typ {
	default:
		if u.typ == "" {
			return fmt.Errorf("invalid value in WorkbookStatsPanelScope type")
		}
		return unknownFunc(u.typ)
	case "selectedTab":
		if u.selectedTab == nil {
		...
		return selectedTabFunc(*u.selectedTab)
	case "allTabs":
		if u.allTabs == nil {
			return fmt.Errorf("field \"allTabs\" is required")
		}
		return allTabsFunc(*u.allTabs)
	}
}

func (u *WorkbookStatsPanelScope) SelectedTabNoopSuccess(_ SelectedTabStatsPanelScope) error {
	return nil
}

func (u *WorkbookStatsPanelScope) AllTabsNoopSuccess(_ AllTabsStatsPanelScope) error {
	return nil
}

func (u *WorkbookStatsPanelScope) ErrorOnUnknown(typeName string) error {
	return fmt.Errorf("invalid value in union type. Type name: %s", typeName)
}

func (u *WorkbookStatsPanelScope) Accept(v WorkbookStatsPanelScopeVisitor) error {
	switch u.typ {
	default:
		if u.typ == "" {
			return fmt.Errorf("invalid value in union type")
	...
	case "selectedTab":
		...
		return v.VisitSelectedTab(*u.selectedTab)
	case "allTabs":
		if u.allTabs == nil {
			return fmt.Errorf("field \"allTabs\" is required")
		}
		return v.VisitAllTabs(*u.allTabs)
	}
}

type WorkbookStatsPanelScopeVisitor interface {
	VisitSelectedTab(v SelectedTabStatsPanelScope) error
	VisitAllTabs(v AllTabsStatsPanelScope) error
	VisitUnknown(typeName string) error
}

func (u *WorkbookStatsPanelScope) AcceptWithContext(ctx context.Context, v WorkbookStatsPanelScopeVisitorWithContext) error {
	switch u.typ {
	default:
		if u.typ == "" {
			return fmt.Errorf("invalid value in union type")
	...
	case "selectedTab":
		...
		return v.VisitSelectedTabWithContext(ctx, *u.selectedTab)
	case "allTabs":
		if u.allTabs == nil {
			return fmt.Errorf("field \"allTabs\" is required")
		}
		return v.VisitAllTabsWithContext(ctx, *u.allTabs)
	}
}

type WorkbookStatsPanelScopeVisitorWithContext interface {
	VisitSelectedTabWithContext(ctx context.Context, v SelectedTabStatsPanelScope) error
	VisitAllTabsWithContext(ctx context.Context, v AllTabsStatsPanelScope) error
	VisitUnknownWithContext(ctx context.Context, typeName string) error
}

func NewWorkbookStatsPanelScopeFromSelectedTab(v SelectedTabStatsPanelScope) WorkbookStatsPanelScope {
	return WorkbookStatsPanelScope{typ: "selectedTab", selectedTab: &v}
}

func NewWorkbookStatsPanelScopeFromAllTabs(v AllTabsStatsPanelScope) WorkbookStatsPanelScope {
	return WorkbookStatsPanelScope{typ: "allTabs", allTabs: &v}
}

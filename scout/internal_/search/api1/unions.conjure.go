...
type searchQueryDeserializer struct {
	...
	DateTimeFieldPresent  *string                             `json:"dateTimeFieldPresent"`
...
func (u *searchQueryDeserializer) toStruct() SearchQuery {
	return SearchQuery{typ: u.Type, dateTimeField: u.DateTimeField, stringField: u.StringField, timestampField: u.TimestampField, longField: u.LongField, booleanField: u.BooleanField, exactMatch: u.ExactMatch, stringArrayExactMatch: u.StringArrayExactMatch, stringArrayLength: u.StringArrayLength, searchText: u.SearchText, label: u.Label, property: u.Property, numericProperty: u.NumericProperty, numericPropertyRange: u.NumericPropertyRange, propertyKey: u.PropertyKey, dateTimeFieldPresent: u.DateTimeFieldPresent, and: u.And, or: u.Or, not: u.Not, workspace: u.Workspace, createdAt: u.CreatedAt, archivedStatus: u.ArchivedStatus, isPublished: u.IsPublished, rids: u.Rids}
}
...
func (u *SearchQuery) toSerializer() (interface{}, error) {
	...
	case "dateTimeFieldPresent":
		if u.dateTimeFieldPresent == nil {
			return nil, fmt.Errorf("field \"dateTimeFieldPresent\" is required")
		}
		return struct {
			Type                 string `json:"type"`
			DateTimeFieldPresent string `json:"dateTimeFieldPresent"`
		}{Type: "dateTimeFieldPresent", DateTimeFieldPresent: *u.dateTimeFieldPresent}, nil
	case "and":
		if u.and == nil {
...
func (u *SearchQuery) UnmarshalJSON(data []byte) error {
	...
	*u = deser.toStruct()
	...
	case "dateTimeFieldPresent":
		if u.dateTimeFieldPresent == nil {
			return fmt.Errorf("field \"dateTimeFieldPresent\" is required")
		}
	case "and":
		if u.and == nil {
...
func (u *SearchQuery) DateTimeFieldPresentNoopSuccess(_ string) error {
	return nil
}
...
func (u *SearchQuery) RidsNoopSuccess(_ []rid.ResourceIdentifier) error {
	return nil
}
...
func (u *SearchQuery) Accept(v SearchQueryVisitor) error {
	...
	case "dateTimeFieldPresent":
		...
		return v.VisitDateTimeFieldPresent(*u.dateTimeFieldPresent)
	case "and":
		if u.and == nil {
			return fmt.Errorf("field \"and\" is required")
		}
...
type SearchQueryVisitor interface {
	...
	VisitDateTimeFieldPresent(v string) error
...
func (u *SearchQuery) AcceptWithContext(ctx context.Context, v SearchQueryVisitorWithContext) error {
	...
	case "dateTimeFieldPresent":
		...
		return v.VisitDateTimeFieldPresentWithContext(ctx, *u.dateTimeFieldPresent)
	case "and":
		if u.and == nil {
			return fmt.Errorf("field \"and\" is required")
		}
...
type SearchQueryVisitorWithContext interface {
	...
	VisitDateTimeFieldPresentWithContext(ctx context.Context, v string) error
...
func NewSearchQueryFromDateTimeFieldPresent(v string) SearchQuery {
	return SearchQuery{typ: "dateTimeFieldPresent", dateTimeFieldPresent: &v}
}
...
func NewSearchQueryFromRids(v []rid.ResourceIdentifier) SearchQuery {
	return SearchQuery{typ: "rids", rids: &v}
}

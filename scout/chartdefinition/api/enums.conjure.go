...
type TankMarkerPosition struct {
	val TankMarkerPosition_Value
}

type TankMarkerPosition_Value string

const (
	TankMarkerPosition_LEFT    TankMarkerPosition_Value = "LEFT"
	TankMarkerPosition_RIGHT   TankMarkerPosition_Value = "RIGHT"
	TankMarkerPosition_UNKNOWN TankMarkerPosition_Value = "UNKNOWN"
)

// TankMarkerPosition_Values returns all known variants of TankMarkerPosition.
func TankMarkerPosition_Values() []TankMarkerPosition_Value {
	return []TankMarkerPosition_Value{TankMarkerPosition_LEFT, TankMarkerPosition_RIGHT}
}

func New_TankMarkerPosition(value TankMarkerPosition_Value) TankMarkerPosition {
	return TankMarkerPosition{val: value}
}

// IsUnknown returns false for all known variants of TankMarkerPosition and true otherwise.
func (e TankMarkerPosition) IsUnknown() bool {
	switch e.val {
	case TankMarkerPosition_LEFT, TankMarkerPosition_RIGHT:
		return false
	}
	return true
}

func (e TankMarkerPosition) Value() TankMarkerPosition_Value {
	if e.IsUnknown() {
		return TankMarkerPosition_UNKNOWN
	}
	return e.val
}

func (e TankMarkerPosition) String() string {
	return string(e.val)
}

func (e TankMarkerPosition) MarshalText() ([]byte, error) {
	return []byte(e.val), nil
}

func (e *TankMarkerPosition) UnmarshalText(data []byte) error {
	switch v := strings.ToUpper(string(data)); v {
	default:
		*e = New_TankMarkerPosition(TankMarkerPosition_Value(v))
	case "LEFT":
		*e = New_TankMarkerPosition(TankMarkerPosition_LEFT)
	case "RIGHT":
		*e = New_TankMarkerPosition(TankMarkerPosition_RIGHT)
	}
	return nil
}
...
type ValveState struct {
	val ValveState_Value
}

type ValveState_Value string

const (
	ValveState_OPEN    ValveState_Value = "OPEN"
	ValveState_CLOSED  ValveState_Value = "CLOSED"
	ValveState_UNKNOWN ValveState_Value = "UNKNOWN"
)

// ValveState_Values returns all known variants of ValveState.
func ValveState_Values() []ValveState_Value {
	return []ValveState_Value{ValveState_OPEN, ValveState_CLOSED}
}

func New_ValveState(value ValveState_Value) ValveState {
	return ValveState{val: value}
}

// IsUnknown returns false for all known variants of ValveState and true otherwise.
func (e ValveState) IsUnknown() bool {
	switch e.val {
	case ValveState_OPEN, ValveState_CLOSED:
		return false
	}
	return true
}

func (e ValveState) Value() ValveState_Value {
	if e.IsUnknown() {
		return ValveState_UNKNOWN
	}
	return e.val
}

func (e ValveState) String() string {
	return string(e.val)
}

func (e ValveState) MarshalText() ([]byte, error) {
	return []byte(e.val), nil
}

func (e *ValveState) UnmarshalText(data []byte) error {
	switch v := strings.ToUpper(string(data)); v {
	default:
		*e = New_ValveState(ValveState_Value(v))
	case "OPEN":
		*e = New_ValveState(ValveState_OPEN)
	case "CLOSED":
		*e = New_ValveState(ValveState_CLOSED)
	}
	return nil
}

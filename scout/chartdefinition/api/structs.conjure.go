...
type BoundaryVizDefinitionV1 struct {
	...
	/*
	   Fill color of the boundary. A pipe coming out of a source boundary
	   inherits this color.
	*/
	FillColor *api.HexColor `json:"fillColor,omitempty" safelogging:"@Safe"`
}

func (o BoundaryVizDefinitionV1) MarshalYAML() (interface{}, error) {
	jsonBytes, err := safejson.Marshal(o)
	if err != nil {
		return nil, err
	}
...
func (o *BoundaryVizDefinitionV1) UnmarshalYAML(unmarshal func(interface{}) error) error {
	jsonBytes, err := safeyaml.UnmarshalerToJSONBytes(unmarshal)
	if err != nil {
		return err
	}
...
func (o CommandConfirmation) MarshalYAML() (interface{}, error) {
	jsonBytes, err := safejson.Marshal(o)
	if err != nil {
		return nil, err
	}
...
func (o *CommandConfirmation) UnmarshalYAML(unmarshal func(interface{}) error) error {
	jsonBytes, err := safeyaml.UnmarshalerToJSONBytes(unmarshal)
	if err != nil {
		return err
	}
...
// How to draw connecting lines between points
type ConnectingLineConfiguration struct {
	Style ConnectingLineStyle `json:"style"`
	// When true, points connect regardless of the staleness threshold, as if the threshold were infinite. By default, gaps wider than the threshold are left unconnected.
	AlwaysConnected *bool `json:"alwaysConnected,omitempty"`
}

func (o ConnectingLineConfiguration) MarshalYAML() (interface{}, error) {
	jsonBytes, err := safejson.Marshal(o)
	if err != nil {
		return nil, err
	}
...
func (o *ConnectingLineConfiguration) UnmarshalYAML(unmarshal func(interface{}) error) error {
	jsonBytes, err := safeyaml.UnmarshalerToJSONBytes(unmarshal)
	if err != nil {
		return err
	}
...
type FloatingLegendConfig struct {
	...
	// When to omit series that have no points in the visible time range from the legend. If undefined, defaults to never.
	HideEmptySeries *HideEmptySeries `json:"hideEmptySeries,omitempty"`
}
...
type ForwardFillConnectingLine struct{}

func (o ForwardFillConnectingLine) MarshalYAML() (interface{}, error) {
	jsonBytes, err := safejson.Marshal(o)
	if err != nil {
		return nil, err
	}
...
func (o *ForwardFillConnectingLine) UnmarshalYAML(unmarshal func(interface{}) error) error {
	jsonBytes, err := safeyaml.UnmarshalerToJSONBytes(unmarshal)
	if err != nil {
		return err
	}
...
type Geo3dPositionLocal struct {
	XVariableName *api2.ChannelVariableName `json:"xVariableName,omitempty" safelogging:"@Unsafe"`
	YVariableName *api2.ChannelVariableName `json:"yVariableName,omitempty" safelogging:"@Unsafe"`
	ZVariableName *api2.ChannelVariableName `json:"zVariableName,omitempty" safelogging:"@Unsafe"`
}
...
func (o HideEmptySeriesAlways) MarshalYAML() (interface{}, error) {
	jsonBytes, err := safejson.Marshal(o)
	if err != nil {
		return nil, err
	}
...
func (o *HideEmptySeriesAlways) UnmarshalYAML(unmarshal func(interface{}) error) error {
	jsonBytes, err := safeyaml.UnmarshalerToJSONBytes(unmarshal)
	if err != nil {
		return err
	}
...
// Never omit empty series from the legend.
type HideEmptySeriesNever struct{}

func (o HideEmptySeriesNever) MarshalYAML() (interface{}, error) {
	jsonBytes, err := safejson.Marshal(o)
	if err != nil {
		return nil, err
	}
...
func (o *HideEmptySeriesNever) UnmarshalYAML(unmarshal func(interface{}) error) error {
	jsonBytes, err := safeyaml.UnmarshalerToJSONBytes(unmarshal)
	if err != nil {
		return err
	}
...
// Omit empty series from the legend only while the chart streams live data.
type HideEmptySeriesWhileStreaming struct{}

func (o HideEmptySeriesWhileStreaming) MarshalYAML() (interface{}, error) {
	jsonBytes, err := safejson.Marshal(o)
	if err != nil {
		return nil, err
	}
...
func (o *HideEmptySeriesWhileStreaming) UnmarshalYAML(unmarshal func(interface{}) error) error {
	jsonBytes, err := safeyaml.UnmarshalerToJSONBytes(unmarshal)
	if err != nil {
		return err
	}
...
// A connection point, positioned on an unrotated image.
type ImageAnchor struct {
	// Horizontal position from 0 to 1 across the unrotated image, left to right.
	X float64 `json:"x"`
	// Vertical position from 0 to 1 down the unrotated image, top to bottom.
	Y float64 `json:"y"`
}

func (o ImageAnchor) MarshalYAML() (interface{}, error) {
	jsonBytes, err := safejson.Marshal(o)
	if err != nil {
		return nil, err
	}
...
func (o *ImageAnchor) UnmarshalYAML(unmarshal func(interface{}) error) error {
	jsonBytes, err := safeyaml.UnmarshalerToJSONBytes(unmarshal)
	if err != nil {
		return err
	}
...
type ImageVizDefinitionV1 struct {
	...
	// Clockwise rotation in degrees. Multiples of 90; absent means no rotation.
	RotationDegrees *int `json:"rotationDegrees,omitempty"`
	// Connection points, keyed by the id CanvasEndpoint.anchorId references.
	Anchors *map[uuid.UUID]ImageAnchor `json:"anchors,omitempty"`
}
...
type LinearInterpolationConnectingLine struct{}

func (o LinearInterpolationConnectingLine) MarshalYAML() (interface{}, error) {
	jsonBytes, err := safejson.Marshal(o)
	if err != nil {
		return nil, err
	}
...
func (o *LinearInterpolationConnectingLine) UnmarshalYAML(unmarshal func(interface{}) error) error {
	jsonBytes, err := safeyaml.UnmarshalerToJSONBytes(unmarshal)
	if err != nil {
		return err
	}
...
func (o NoConnectingLine) MarshalYAML() (interface{}, error) {
	jsonBytes, err := safejson.Marshal(o)
	if err != nil {
		return nil, err
	}
...
*/
type NumericBetweenPredicate struct {
	Lower float64 `json:"lower"`
	Upper float64 `json:"upper"`
}

func (o NumericBetweenPredicate) MarshalYAML() (interface{}, error) {
	jsonBytes, err := safejson.Marshal(o)
	if err != nil {
		return nil, err
	}
...
func (o *NumericBetweenPredicate) UnmarshalYAML(unmarshal func(interface{}) error) error {
	jsonBytes, err := safeyaml.UnmarshalerToJSONBytes(unmarshal)
	if err != nil {
		return err
	}
...
type PumpVizDefinitionV1 struct {
	...
	FeedbackVariableName api2.ChannelVariableName `json:"feedbackVariableName" safelogging:"@Unsafe"`
	// Clockwise rotation in degrees. Multiples of 90; absent means no rotation.
	RotationDegrees *int `json:"rotationDegrees,omitempty"`
}

func (o PumpVizDefinitionV1) MarshalYAML() (interface{}, error) {
	jsonBytes, err := safejson.Marshal(o)
	if err != nil {
		return nil, err
	}
...
func (o *PumpVizDefinitionV1) UnmarshalYAML(unmarshal func(interface{}) error) error {
	jsonBytes, err := safeyaml.UnmarshalerToJSONBytes(unmarshal)
	if err != nil {
		return err
	}
...
type SendCommandsAction struct {
	/*
	   The commands to send when the action is activated. Must be
	   non-empty and contain at most 32 entries. Translated at activation
	   time into a command service SendCommands request.
	*/
	Commands []VizCommand `json:"commands"`
}

func (o SendCommandsAction) MarshalJSON() ([]byte, error) {
	if o.Commands == nil {
		o.Commands = make([]VizCommand, 0)
	}
	type _tmpSendCommandsAction SendCommandsAction
	return safejson.Marshal(_tmpSendCommandsAction(o))
}

func (o *SendCommandsAction) UnmarshalJSON(data []byte) error {
	type _tmpSendCommandsAction SendCommandsAction
	var rawSendCommandsAction _tmpSendCommandsAction
	if err := safejson.Unmarshal(data, &rawSendCommandsAction); err != nil {
		return err
	}
	if rawSendCommandsAction.Commands == nil {
		rawSendCommandsAction.Commands = make([]VizCommand, 0)
	}
	*o = SendCommandsAction(rawSendCommandsAction)
	return nil
}

func (o SendCommandsAction) MarshalYAML() (interface{}, error) {
	jsonBytes, err := safejson.Marshal(o)
	if err != nil {
		return nil, err
	}
...
func (o *SendCommandsAction) UnmarshalYAML(unmarshal func(interface{}) error) error {
	jsonBytes, err := safeyaml.UnmarshalerToJSONBytes(unmarshal)
	if err != nil {
		return err
	}
...
func (o SinkBoundary) MarshalYAML() (interface{}, error) {
	jsonBytes, err := safejson.Marshal(o)
	if err != nil {
		return nil, err
	}
...
func (o SourceBoundary) MarshalYAML() (interface{}, error) {
	jsonBytes, err := safejson.Marshal(o)
	if err != nil {
		return nil, err
	}
...
func (o *SourceBoundary) UnmarshalYAML(unmarshal func(interface{}) error) error {
	jsonBytes, err := safeyaml.UnmarshalerToJSONBytes(unmarshal)
	if err != nil {
		return err
	}
...
type StandardPump struct{}

func (o StandardPump) MarshalYAML() (interface{}, error) {
	jsonBytes, err := safejson.Marshal(o)
	if err != nil {
		return nil, err
	}
...
func (o *StandardPump) UnmarshalYAML(unmarshal func(interface{}) error) error {
	jsonBytes, err := safeyaml.UnmarshalerToJSONBytes(unmarshal)
	if err != nil {
		return err
	}
...
func (o StandardValve) MarshalJSON() ([]byte, error) {
	...
	type _tmpStandardValve StandardValve
	return safejson.Marshal(_tmpStandardValve(o))
}

func (o *StandardValve) UnmarshalJSON(data []byte) error {
	type _tmpStandardValve StandardValve
	var rawStandardValve _tmpStandardValve
	if err := safejson.Unmarshal(data, &rawStandardValve); err != nil {
		return err
	}
	if rawStandardValve.StateMappings == nil {
		rawStandardValve.StateMappings = make([]ValveStateRule, 0)
	}
	if rawStandardValve.Actions == nil {
		rawStandardValve.Actions = make([]VizActionOption, 0)
	}
	*o = StandardValve(rawStandardValve)
	return nil
}

func (o StandardValve) MarshalYAML() (interface{}, error) {
	jsonBytes, err := safejson.Marshal(o)
	if err != nil {
		return nil, err
	}
...
func (o *StandardValve) UnmarshalYAML(unmarshal func(interface{}) error) error {
	jsonBytes, err := safeyaml.UnmarshalerToJSONBytes(unmarshal)
	if err != nil {
		return err
	}
...
type TableColumn struct {
	Name        api2.ChannelVariableName `json:"name" safelogging:"@Unsafe"`
...
type TankVizDefinitionV1 struct {
	...
	// Side of the gauge the level marker renders on.
	MarkerPosition TankMarkerPosition `json:"markerPosition"`
	// Whether the level marker renders its value label.
	ShowMarkerLabel bool `json:"showMarkerLabel"`
	// Fill color of the tank level.
	FillColor api.HexColor `json:"fillColor" safelogging:"@Safe"`
	// Workbook channel variable providing the tank level feedback.
	FeedbackVariableName api2.ChannelVariableName `json:"feedbackVariableName" safelogging:"@Unsafe"`
}

func (o TankVizDefinitionV1) MarshalYAML() (interface{}, error) {
	jsonBytes, err := safejson.Marshal(o)
	if err != nil {
		return nil, err
	}
...
func (o *TankVizDefinitionV1) UnmarshalYAML(unmarshal func(interface{}) error) error {
	jsonBytes, err := safeyaml.UnmarshalerToJSONBytes(unmarshal)
	if err != nil {
		return err
	}
...
// safelogging:@Unsafe
type ValveInputPredicate struct {
	// Workbook channel variable providing numeric valve feedback.
	VariableName api2.ChannelVariableName `json:"variableName" safelogging:"@Unsafe"`
	Predicate    ValuePredicate           `json:"predicate"`
}

func (o ValveInputPredicate) MarshalYAML() (interface{}, error) {
	jsonBytes, err := safejson.Marshal(o)
	if err != nil {
		return nil, err
	}
...
func (o *ValveInputPredicate) UnmarshalYAML(unmarshal func(interface{}) error) error {
	jsonBytes, err := safeyaml.UnmarshalerToJSONBytes(unmarshal)
	if err != nil {
		return err
	}
...
/*
Conjunction of one or more input predicates. All predicates must match
at the same evaluation timestamp for the condition to match.
*/
type ValveStateCondition struct {
	// Must contain between 1 and 8 predicates.
	AllOf []ValveInputPredicate `json:"allOf"`
}

func (o ValveStateCondition) MarshalJSON() ([]byte, error) {
	if o.AllOf == nil {
		o.AllOf = make([]ValveInputPredicate, 0)
	}
	type _tmpValveStateCondition ValveStateCondition
	return safejson.Marshal(_tmpValveStateCondition(o))
}

func (o *ValveStateCondition) UnmarshalJSON(data []byte) error {
	type _tmpValveStateCondition ValveStateCondition
	var rawValveStateCondition _tmpValveStateCondition
	if err := safejson.Unmarshal(data, &rawValveStateCondition); err != nil {
		return err
	}
	if rawValveStateCondition.AllOf == nil {
		rawValveStateCondition.AllOf = make([]ValveInputPredicate, 0)
	}
	*o = ValveStateCondition(rawValveStateCondition)
	return nil
}

func (o ValveStateCondition) MarshalYAML() (interface{}, error) {
	jsonBytes, err := safejson.Marshal(o)
	if err != nil {
		return nil, err
	}
...
func (o *ValveStateCondition) UnmarshalYAML(unmarshal func(interface{}) error) error {
	jsonBytes, err := safeyaml.UnmarshalerToJSONBytes(unmarshal)
	if err != nil {
		return err
	}
...
type ValveStateRule struct {
	State     ValveState          `json:"state"`
	Condition ValveStateCondition `json:"condition"`
}

func (o ValveStateRule) MarshalYAML() (interface{}, error) {
	jsonBytes, err := safejson.Marshal(o)
	if err != nil {
		return nil, err
	}
...
func (o *ValveStateRule) UnmarshalYAML(unmarshal func(interface{}) error) error {
	jsonBytes, err := safeyaml.UnmarshalerToJSONBytes(unmarshal)
	if err != nil {
		return err
	}
...
func (o *ValveVizDefinitionV1) UnmarshalYAML(unmarshal func(interface{}) error) error {
	jsonBytes, err := safeyaml.UnmarshalerToJSONBytes(unmarshal)
	if err != nil {
		return err
	}
...
type VerticalTank struct{}

func (o VerticalTank) MarshalYAML() (interface{}, error) {
	jsonBytes, err := safejson.Marshal(o)
	if err != nil {
		return nil, err
	}
...
func (o *VerticalTank) UnmarshalYAML(unmarshal func(interface{}) error) error {
	jsonBytes, err := safeyaml.UnmarshalerToJSONBytes(unmarshal)
	if err != nil {
		return err
	}
...
type VideoVizDefinitionV2 struct {
	Title    *string                  `json:"title,omitempty"`
	Variable api2.ChannelVariableName `json:"variable" safelogging:"@Unsafe"`
}
...
func (o VizActionOption) MarshalYAML() (interface{}, error) {
	jsonBytes, err := safejson.Marshal(o)
	if err != nil {
		return nil, err
	}
...
func (o *VizActionOption) UnmarshalYAML(unmarshal func(interface{}) error) error {
	jsonBytes, err := safeyaml.UnmarshalerToJSONBytes(unmarshal)
	if err != nil {
		return err
	}
...
type VizCommand struct {
	/*
	   ...
	   up in the workbook's channel-variable map at activation time.
	*/
	VariableName api2.ChannelVariableName `json:"variableName" safelogging:"@Unsafe"`
	Value        api.CommandValue         `json:"value"`
}

func (o VizCommand) MarshalYAML() (interface{}, error) {
	jsonBytes, err := safejson.Marshal(o)
	if err != nil {
		return nil, err
	}
...
func (o *VizCommand) UnmarshalYAML(unmarshal func(interface{}) error) error {
	jsonBytes, err := safeyaml.UnmarshalerToJSONBytes(unmarshal)
	if err != nil {
		return err
	}

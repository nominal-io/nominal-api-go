...
type EnrichedDataset struct {
	...
	// Deprecated: Deprecated. Use DatasetFile#handle
	Handle *Handle `json:"handle,omitempty"`
	// Dataset creation time. The name is historical; use lastIngestedAt for when data was last added.
	IngestDate datetime.DateTime `json:"ingestDate"`
	/*
	   When data was last added to this dataset, as the latest of a successful file ingest and streaming-session
	   activity. Empty when the dataset has never received either.
	*/
	LastIngestedAt *datetime.DateTime `json:"lastIngestedAt,omitempty"`

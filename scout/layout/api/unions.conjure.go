...
// A manually edited route. When absent, clients calculate an automatic route.
type CanvasConnectionRouting struct {
	typ        string
	orthogonal *OrthogonalConnectionRouting
}

type canvasConnectionRoutingDeserializer struct {
	Type       string                       `json:"type"`
	Orthogonal *OrthogonalConnectionRouting `json:"orthogonal"`
}

func (u *canvasConnectionRoutingDeserializer) toStruct() CanvasConnectionRouting {
	return CanvasConnectionRouting{typ: u.Type, orthogonal: u.Orthogonal}
}

func (u *CanvasConnectionRouting) toSerializer() (interface{}, error) {
	switch u.typ {
	default:
		return nil, fmt.Errorf("unknown type %q", u.typ)
	case "orthogonal":
		if u.orthogonal == nil {
			return nil, fmt.Errorf("field \"orthogonal\" is required")
		}
		return struct {
			Type       string                      `json:"type"`
			Orthogonal OrthogonalConnectionRouting `json:"orthogonal"`
		}{Type: "orthogonal", Orthogonal: *u.orthogonal}, nil
	}
}

func (u CanvasConnectionRouting) MarshalJSON() ([]byte, error) {
	ser, err := u.toSerializer()
	if err != nil {
		return nil, err
	}
...
func (u *CanvasConnectionRouting) UnmarshalJSON(data []byte) error {
	var deser canvasConnectionRoutingDeserializer
	if err := safejson.Unmarshal(data, &deser); err != nil {
		return err
	}
	*u = deser.toStruct()
	...
	case "orthogonal":
		if u.orthogonal == nil {
			return fmt.Errorf("field \"orthogonal\" is required")
		}
	}
	return nil
}

func (u CanvasConnectionRouting) MarshalYAML() (interface{}, error) {
	jsonBytes, err := safejson.Marshal(u)
	if err != nil {
		return nil, err
	}
...
func (u *CanvasConnectionRouting) UnmarshalYAML(unmarshal func(interface{}) error) error {
	jsonBytes, err := safeyaml.UnmarshalerToJSONBytes(unmarshal)
	if err != nil {
		return err
	}
...
func (u *CanvasConnectionRouting) AcceptFuncs(orthogonalFunc func(OrthogonalConnectionRouting) error, unknownFunc func(string) error) error {
	switch u.typ {
	default:
		if u.typ == "" {
			return fmt.Errorf("invalid value in CanvasConnectionRouting type")
		}
		return unknownFunc(u.typ)
	case "orthogonal":
		if u.orthogonal == nil {
		...
		return orthogonalFunc(*u.orthogonal)
	}
}

func (u *CanvasConnectionRouting) OrthogonalNoopSuccess(_ OrthogonalConnectionRouting) error {
	return nil
}

func (u *CanvasConnectionRouting) ErrorOnUnknown(typeName string) error {
	return fmt.Errorf("invalid value in union type. Type name: %s", typeName)
}

func (u *CanvasConnectionRouting) Accept(v CanvasConnectionRoutingVisitor) error {
	switch u.typ {
	default:
		if u.typ == "" {
			return fmt.Errorf("invalid value in union type")
	...
	case "orthogonal":
		...
		return v.VisitOrthogonal(*u.orthogonal)
	}
}

type CanvasConnectionRoutingVisitor interface {
	VisitOrthogonal(v OrthogonalConnectionRouting) error
	VisitUnknown(typeName string) error
}

func (u *CanvasConnectionRouting) AcceptWithContext(ctx context.Context, v CanvasConnectionRoutingVisitorWithContext) error {
	switch u.typ {
	default:
		if u.typ == "" {
			return fmt.Errorf("invalid value in union type")
	...
	case "orthogonal":
		...
		return v.VisitOrthogonalWithContext(ctx, *u.orthogonal)
	}
}

type CanvasConnectionRoutingVisitorWithContext interface {
	VisitOrthogonalWithContext(ctx context.Context, v OrthogonalConnectionRouting) error
	VisitUnknownWithContext(ctx context.Context, typeName string) error
}

func NewCanvasConnectionRoutingFromOrthogonal(v OrthogonalConnectionRouting) CanvasConnectionRouting {
	return CanvasConnectionRouting{typ: "orthogonal", orthogonal: &v}
}

...
type NumericSeriesNode struct {
	...
	unitOverride                      *UnitOverrideSeriesNode
...
type numericSeriesNodeDeserializer struct {
	...
	UnitOverride                      *UnitOverrideSeriesNode                       `json:"unitOverride"`
...
func (u *numericSeriesNodeDeserializer) toStruct() NumericSeriesNode {
	return NumericSeriesNode{typ: u.Type, constant: u.Constant, arithmetic: u.Arithmetic, bitOperation: u.BitOperation, countDuplicate: u.CountDuplicate, cumulativeSum: u.CumulativeSum, derivative: u.Derivative, integral: u.Integral, max: u.Max, mean: u.Mean, min: u.Min, offset: u.Offset, product: u.Product, oldestPoints: u.OldestPoints, raw: u.Raw, resample: u.Resample, nthPointDownsample: u.NthPointDownsample, largestTriangleThreeBuckets: u.LargestTriangleThreeBuckets, rollingOperation: u.RollingOperation, rollingPointOperation: u.RollingPointOperation, aggregate: u.Aggregate, signalFilter: u.SignalFilter, sum: u.Sum, scale: u.Scale, timeDifference: u.TimeDifference, union: u.Union, unitConversion: u.UnitConversion, unitOverride: u.UnitOverride, valueDifference: u.ValueDifference, filterTransformation: u.FilterTransformation, thresholdFilter: u.ThresholdFilter, dropNan: u.DropNan, arraySelect: u.ArraySelect, absoluteTimestamp: u.AbsoluteTimestamp, newestPoints: u.NewestPoints, rangesNumericAggregationToNumeric: u.RangesNumericAggregationToNumeric, rangeDuration: u.RangeDuration, filterByExpression: u.FilterByExpression, scalarUdf: u.ScalarUdf, enumToNumeric: u.EnumToNumeric, contains: u.Contains, refprop: u.Refprop, extractFromStruct: u.ExtractFromStruct, zScore: u.ZScore, phaseUnwrap: u.PhaseUnwrap, genericTransform: u.GenericTransform}
}
...
func (u *NumericSeriesNode) UnitOverrideNoopSuccess(_ UnitOverrideSeriesNode) error {
	return nil
}
...
type NumericSeriesNodeVisitor interface {
	...
	VisitUnitOverride(v UnitOverrideSeriesNode) error
...
type NumericSeriesNodeVisitorWithContext interface {
	...
	VisitUnitOverrideWithContext(ctx context.Context, v UnitOverrideSeriesNode) error
...
func NewNumericSeriesNodeFromUnitOverride(v UnitOverrideSeriesNode) NumericSeriesNode {
	return NumericSeriesNode{typ: "unitOverride", unitOverride: &v}
}

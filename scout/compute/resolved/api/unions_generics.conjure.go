...
func (u *NumericSeriesNodeWithT[T]) Accept(ctx context.Context, v NumericSeriesNodeVisitorWithT[T]) (T, error) {
	...
	case "unitOverride":
		if u.unitOverride == nil {
			return result, fmt.Errorf("field \"unitOverride\" is required")
		}
		return v.VisitUnitOverride(ctx, *u.unitOverride)
...
func (u *NumericSeriesNodeWithT[T]) UnitOverrideNoopSuccess(UnitOverrideSeriesNode) (T, error) {
	var result T
	return result, nil
}
...
type NumericSeriesNodeVisitorWithT[T any] interface {
	...
	VisitUnitOverride(ctx context.Context, v UnitOverrideSeriesNode) (T, error)

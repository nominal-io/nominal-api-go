...
func (e *QuerySource) UnmarshalText(data []byte) error {
	...
	case "DERIVED_SERIES_TAG_SEARCH":
		*e = New_QuerySource(QuerySource_DERIVED_SERIES_TAG_SEARCH)
	case "SQL_EXPORT":
...
const (
	...
	TagFilterValidationErrorType_FILTER_KEY_NOT_IN_SELECTED_TAGS    TagFilterValidationErrorType_Value = "FILTER_KEY_NOT_IN_SELECTED_TAGS"
...
func TagFilterValidationErrorType_Values() []TagFilterValidationErrorType_Value {
	return []TagFilterValidationErrorType_Value{TagFilterValidationErrorType_BOTH_TAGS_AND_TAG_FILTERS_PROVIDED, TagFilterValidationErrorType_EMPTY_FILTER_LIST, TagFilterValidationErrorType_EMPTY_TAG_VALUE_SET, TagFilterValidationErrorType_NESTED_AND_OPERATIONS, TagFilterValidationErrorType_DUPLICATE_TAG_KEY, TagFilterValidationErrorType_FILTER_KEY_NOT_IN_SELECTED_TAGS}
}
...
func (e *TagFilterValidationErrorType) UnmarshalText(data []byte) error {
	...
	case "FILTER_KEY_NOT_IN_SELECTED_TAGS":
		*e = New_TagFilterValidationErrorType(TagFilterValidationErrorType_FILTER_KEY_NOT_IN_SELECTED_TAGS)
	}
	return nil
}

...
in the input's absolute time domain. Currently run boundary, event, and range anchors are supported, and
every storage-backed leaf of the input must resolve to run-backed branches.
*/
...
/*
Uses the start timestamp of the event at the configured zero-based index from this query whose event time
lies in the anchor window [start, end), or [start, +infinity) when the end is absent. The window is the run
bounds for a run anchor. Shares the wire shape of `numeric.EventTimeShift`, which tagByIntervals time shifts
use; a separate type so dataset anchors evolve independently.
*/
...
func (o EventAnchor) MarshalYAML() (interface{}, error) {
	jsonBytes, err := safejson.Marshal(o)
	if err != nil {
		return nil, err
	}
...
func (o *EventAnchor) UnmarshalYAML(unmarshal func(interface{}) error) error {
	jsonBytes, err := safeyaml.UnmarshalerToJSONBytes(unmarshal)
	if err != nil {
		return err
	}
...
type RangesAnchor struct {
	...
	SortOrder *api1.RangeSortOrder `json:"sortOrder,omitempty"`
}

func (o RangesAnchor) MarshalYAML() (interface{}, error) {
	jsonBytes, err := safejson.Marshal(o)
	if err != nil {
		return nil, err
	}
...
func (o *RangesAnchor) UnmarshalYAML(unmarshal func(interface{}) error) error {
	jsonBytes, err := safeyaml.UnmarshalerToJSONBytes(unmarshal)
	if err != nil {
		return err
	}
...
/*
Override the unit of the given series without changing its values. Unlike unit conversion, no
compatibility with the input's current unit is required.
*/
// safelogging:@Unsafe
type UnitOverrideSeries struct {
	Input NumericSeries `json:"input"`
	// The unit to report for the input series. If absent, the input's unit is cleared.
	Unit *api3.UnitSymbol `json:"unit,omitempty" safelogging:"@Unsafe"`
}

func (o UnitOverrideSeries) MarshalYAML() (interface{}, error) {
	jsonBytes, err := safejson.Marshal(o)
	if err != nil {
		return nil, err
	}
...
func (o *UnitOverrideSeries) UnmarshalYAML(unmarshal func(interface{}) error) error {
	jsonBytes, err := safeyaml.UnmarshalerToJSONBytes(unmarshal)
	if err != nil {
		return err
	}

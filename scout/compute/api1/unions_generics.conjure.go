...
func (u *IntervalAnchorWithT[T]) Accept(ctx context.Context, v IntervalAnchorVisitorWithT[T]) (T, error) {
	...
	case "rangeInInterval":
		if u.rangeInInterval == nil {
			return result, fmt.Errorf("field \"rangeInInterval\" is required")
		}
		return v.VisitRangeInInterval(ctx, *u.rangeInInterval)
	}
}

func (u *IntervalAnchorWithT[T]) AcceptFuncs(intervalStartFunc func(api.IntervalStartTimeShift) (T, error), intervalEndFunc func(api.IntervalEndTimeShift) (T, error), eventInIntervalFunc func(EventAnchor) (T, error), rangeInIntervalFunc func(RangesAnchor) (T, error), unknownFunc func(string) (T, error)) (T, error) {
	var result T
	switch u.typ {
	default:
		if u.typ == "" {
...
func (u *IntervalAnchorWithT[T]) EventInIntervalNoopSuccess(EventAnchor) (T, error) {
	var result T
	return result, nil
}

func (u *IntervalAnchorWithT[T]) RangeInIntervalNoopSuccess(RangesAnchor) (T, error) {
	var result T
	return result, nil
}
...
type IntervalAnchorVisitorWithT[T any] interface {
	...
	VisitEventInInterval(ctx context.Context, v EventAnchor) (T, error)
	VisitRangeInInterval(ctx context.Context, v RangesAnchor) (T, error)
	VisitUnknown(ctx context.Context, typ string) (T, error)
}
...
func (u *NumericSeriesWithT[T]) UnitOverrideNoopSuccess(UnitOverrideSeries) (T, error) {
	var result T
	return result, nil
}
...
type NumericSeriesVisitorWithT[T any] interface {
	...
	VisitUnitOverride(ctx context.Context, v UnitOverrideSeries) (T, error)

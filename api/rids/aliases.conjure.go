...
/*
Unique resource identifier for a single turn (one agent run) within a
conversation with the Nominal LLM Agent. Seeds the turn's Langfuse trace id.
*/
type AiTurnRid rid.ResourceIdentifier // safelogging:@Safe

func (a AiTurnRid) String() string {
	return rid.ResourceIdentifier(a).String()
}

func (a AiTurnRid) MarshalText() ([]byte, error) {
	return rid.ResourceIdentifier(a).MarshalText()
}

func (a *AiTurnRid) UnmarshalText(data []byte) error {
	var rawAiTurnRid rid.ResourceIdentifier
	if err := rawAiTurnRid.UnmarshalText(data); err != nil {
		return err
	}
	*a = AiTurnRid(rawAiTurnRid)
	return nil
}

func (a AiTurnRid) MarshalJSON() ([]byte, error) {
	return safejson.Marshal(rid.ResourceIdentifier(a))
}

func (a *AiTurnRid) UnmarshalJSON(data []byte) error {
	var rawAiTurnRid rid.ResourceIdentifier
	if err := safejson.Unmarshal(data, &rawAiTurnRid); err != nil {
		return err
	}
	*a = AiTurnRid(rawAiTurnRid)
	return nil
...
func (a AiTurnRid) MarshalYAML() (interface{}, error) {
	jsonBytes, err := safejson.Marshal(a)
	if err != nil {
		return nil, err
	}
...
func (a *AiTurnRid) UnmarshalYAML(unmarshal func(interface{}) error) error {
	jsonBytes, err := safeyaml.UnmarshalerToJSONBytes(unmarshal)
	if err != nil {
		return err
	}
...
// Unique resource identifier for a Nova app version.
type NovaAppVersionRid rid.ResourceIdentifier // safelogging:@Safe

func (a NovaAppVersionRid) String() string {
	return rid.ResourceIdentifier(a).String()
}

func (a NovaAppVersionRid) MarshalText() ([]byte, error) {
	return rid.ResourceIdentifier(a).MarshalText()
}

func (a *NovaAppVersionRid) UnmarshalText(data []byte) error {
	var rawNovaAppVersionRid rid.ResourceIdentifier
	if err := rawNovaAppVersionRid.UnmarshalText(data); err != nil {
		return err
	}
	*a = NovaAppVersionRid(rawNovaAppVersionRid)
	return nil
}

func (a NovaAppVersionRid) MarshalJSON() ([]byte, error) {
	return safejson.Marshal(rid.ResourceIdentifier(a))
}

func (a *NovaAppVersionRid) UnmarshalJSON(data []byte) error {
	var rawNovaAppVersionRid rid.ResourceIdentifier
	if err := safejson.Unmarshal(data, &rawNovaAppVersionRid); err != nil {
		return err
	}
	*a = NovaAppVersionRid(rawNovaAppVersionRid)
	return nil
...
func (a NovaAppVersionRid) MarshalYAML() (interface{}, error) {
	jsonBytes, err := safejson.Marshal(a)
	if err != nil {
		return nil, err
	}
...
func (a *NovaAppVersionRid) UnmarshalYAML(unmarshal func(interface{}) error) error {
	jsonBytes, err := safeyaml.UnmarshalerToJSONBytes(unmarshal)
	if err != nil {
		return err
	}
...
/*
Unique resource identifier for a code sandbox. A sandbox is one Python
interpreter and one workspace.
*/
type SandboxRid rid.ResourceIdentifier // safelogging:@Safe

func (a SandboxRid) String() string {
	return rid.ResourceIdentifier(a).String()
}

func (a SandboxRid) MarshalText() ([]byte, error) {
	return rid.ResourceIdentifier(a).MarshalText()
}

func (a *SandboxRid) UnmarshalText(data []byte) error {
	var rawSandboxRid rid.ResourceIdentifier
	if err := rawSandboxRid.UnmarshalText(data); err != nil {
		return err
	}
	*a = SandboxRid(rawSandboxRid)
	return nil
}

func (a SandboxRid) MarshalJSON() ([]byte, error) {
	return safejson.Marshal(rid.ResourceIdentifier(a))
}

func (a *SandboxRid) UnmarshalJSON(data []byte) error {
	var rawSandboxRid rid.ResourceIdentifier
	if err := safejson.Unmarshal(data, &rawSandboxRid); err != nil {
		return err
	}
	*a = SandboxRid(rawSandboxRid)
	return nil
...
func (a SandboxRid) MarshalYAML() (interface{}, error) {
	jsonBytes, err := safejson.Marshal(a)
	if err != nil {
		return nil, err
	}
...
func (a *SandboxRid) UnmarshalYAML(unmarshal func(interface{}) error) error {
	jsonBytes, err := safeyaml.UnmarshalerToJSONBytes(unmarshal)
	if err != nil {
		return err
	}

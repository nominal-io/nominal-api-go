...
type StreamingSessionSortKey struct {
	val StreamingSessionSortKey_Value
}

type StreamingSessionSortKey_Value string

const (
	// Orders by the time the session was created.
	StreamingSessionSortKey_CREATED_AT StreamingSessionSortKey_Value = "CREATED_AT"
	// Orders by the start of the session's data bounds. Sessions with no data bounds are excluded from the results.
	StreamingSessionSortKey_DATA_BOUNDS_START StreamingSessionSortKey_Value = "DATA_BOUNDS_START"
	StreamingSessionSortKey_UNKNOWN           StreamingSessionSortKey_Value = "UNKNOWN"
)

// StreamingSessionSortKey_Values returns all known variants of StreamingSessionSortKey.
func StreamingSessionSortKey_Values() []StreamingSessionSortKey_Value {
	return []StreamingSessionSortKey_Value{StreamingSessionSortKey_CREATED_AT, StreamingSessionSortKey_DATA_BOUNDS_START}
}

func New_StreamingSessionSortKey(value StreamingSessionSortKey_Value) StreamingSessionSortKey {
	return StreamingSessionSortKey{val: value}
}

// IsUnknown returns false for all known variants of StreamingSessionSortKey and true otherwise.
func (e StreamingSessionSortKey) IsUnknown() bool {
	switch e.val {
	case StreamingSessionSortKey_CREATED_AT, StreamingSessionSortKey_DATA_BOUNDS_START:
		return false
	}
	return true
}

func (e StreamingSessionSortKey) Value() StreamingSessionSortKey_Value {
	if e.IsUnknown() {
		return StreamingSessionSortKey_UNKNOWN
	}
	return e.val
}

func (e StreamingSessionSortKey) String() string {
	return string(e.val)
}

func (e StreamingSessionSortKey) MarshalText() ([]byte, error) {
	return []byte(e.val), nil
}

func (e *StreamingSessionSortKey) UnmarshalText(data []byte) error {
	switch v := strings.ToUpper(string(data)); v {
	default:
		*e = New_StreamingSessionSortKey(StreamingSessionSortKey_Value(v))
	case "CREATED_AT":
		*e = New_StreamingSessionSortKey(StreamingSessionSortKey_CREATED_AT)
	case "DATA_BOUNDS_START":
		*e = New_StreamingSessionSortKey(StreamingSessionSortKey_DATA_BOUNDS_START)
	}
	return nil
}

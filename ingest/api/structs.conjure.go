...
import (
	...
	api3 "github.com/nominal-io/nominal-api-go/authentication/api"
	...
	api4 "github.com/nominal-io/nominal-api-go/scout/spatial/api"
	api6 "github.com/nominal-io/nominal-api-go/scout/video/api"
	api5 "github.com/nominal-io/nominal-api-go/secrets/api"
...
type MeshStreamingSessionSource struct {
	...
	SourceOrgRid                 api3.OrgRid     `json:"sourceOrgRid" safelogging:"@Safe"`
...
type PointCloudOpts struct {
	...
	*/
	DaggerImportConfig interface{} `json:"daggerImportConfig"`
	// Sensor metadata to associate with the point cloud.
	SensorMetadata *api4.PointCloudMetadata `json:"sensorMetadata,omitempty"`
...
// safelogging:@Unsafe
type SearchStreamingSessionsRequest struct {
	// Defaults to 100. Clamped to 1_000 if larger, and to 1 if non-positive.
	PageSize      *int                          `json:"pageSize,omitempty"`
	NextPageToken *api.Token                    `json:"nextPageToken,omitempty" safelogging:"@Unsafe"`
	Filter        *StreamingSessionSearchFilter `json:"filter,omitempty"`
	// Defaults to created_at DESC when omitted.
	Sort *StreamingSessionSortOptions `json:"sort,omitempty"`
}

func (o SearchStreamingSessionsRequest) MarshalYAML() (interface{}, error) {
	jsonBytes, err := safejson.Marshal(o)
	if err != nil {
		return nil, err
	}
...
func (o *SearchStreamingSessionsRequest) UnmarshalYAML(unmarshal func(interface{}) error) error {
	jsonBytes, err := safeyaml.UnmarshalerToJSONBytes(unmarshal)
	if err != nil {
		return err
	}
...
// safelogging:@Unsafe
type SearchStreamingSessionsResponse struct {
	StreamingSessions []StreamingSession `json:"streamingSessions"`
	NextPageToken     *api.Token         `json:"nextPageToken,omitempty" safelogging:"@Unsafe"`
}

func (o SearchStreamingSessionsResponse) MarshalJSON() ([]byte, error) {
	if o.StreamingSessions == nil {
		o.StreamingSessions = make([]StreamingSession, 0)
	}
	type _tmpSearchStreamingSessionsResponse SearchStreamingSessionsResponse
	return safejson.Marshal(_tmpSearchStreamingSessionsResponse(o))
}

func (o *SearchStreamingSessionsResponse) UnmarshalJSON(data []byte) error {
	type _tmpSearchStreamingSessionsResponse SearchStreamingSessionsResponse
	var rawSearchStreamingSessionsResponse _tmpSearchStreamingSessionsResponse
	if err := safejson.Unmarshal(data, &rawSearchStreamingSessionsResponse); err != nil {
		return err
	}
	if rawSearchStreamingSessionsResponse.StreamingSessions == nil {
		rawSearchStreamingSessionsResponse.StreamingSessions = make([]StreamingSession, 0)
	}
	*o = SearchStreamingSessionsResponse(rawSearchStreamingSessionsResponse)
	return nil
}

func (o SearchStreamingSessionsResponse) MarshalYAML() (interface{}, error) {
	jsonBytes, err := safejson.Marshal(o)
	if err != nil {
		return nil, err
	}
...
func (o *SearchStreamingSessionsResponse) UnmarshalYAML(unmarshal func(interface{}) error) error {
	jsonBytes, err := safeyaml.UnmarshalerToJSONBytes(unmarshal)
	if err != nil {
		return err
	}
...
// safelogging:@Unsafe
type SearchStreamingSourcesRequest struct {
	// Defaults to 100. Clamped to 1_000 if larger, and to 1 if non-positive.
	PageSize      *int                         `json:"pageSize,omitempty"`
	NextPageToken *api.Token                   `json:"nextPageToken,omitempty" safelogging:"@Unsafe"`
	Filter        *StreamingSourceSearchFilter `json:"filter,omitempty"`
	/*
	   If present, only sessions last seen strictly after this instant are aggregated;
	   groups whose sessions were all last seen at or before it are omitted.
	*/
	ActivityAfter *api.Timestamp `json:"activityAfter,omitempty"`
}

func (o SearchStreamingSourcesRequest) MarshalYAML() (interface{}, error) {
	jsonBytes, err := safejson.Marshal(o)
	if err != nil {
		return nil, err
	}
...
func (o *SearchStreamingSourcesRequest) UnmarshalYAML(unmarshal func(interface{}) error) error {
	jsonBytes, err := safeyaml.UnmarshalerToJSONBytes(unmarshal)
	if err != nil {
		return err
	}
...
// safelogging:@Unsafe
type SearchStreamingSourcesResponse struct {
	StreamingSources []StreamingSource `json:"streamingSources"`
	NextPageToken    *api.Token        `json:"nextPageToken,omitempty" safelogging:"@Unsafe"`
}

func (o SearchStreamingSourcesResponse) MarshalJSON() ([]byte, error) {
	if o.StreamingSources == nil {
		o.StreamingSources = make([]StreamingSource, 0)
	}
	type _tmpSearchStreamingSourcesResponse SearchStreamingSourcesResponse
	return safejson.Marshal(_tmpSearchStreamingSourcesResponse(o))
}

func (o *SearchStreamingSourcesResponse) UnmarshalJSON(data []byte) error {
	type _tmpSearchStreamingSourcesResponse SearchStreamingSourcesResponse
	var rawSearchStreamingSourcesResponse _tmpSearchStreamingSourcesResponse
	if err := safejson.Unmarshal(data, &rawSearchStreamingSourcesResponse); err != nil {
		return err
	}
	if rawSearchStreamingSourcesResponse.StreamingSources == nil {
		rawSearchStreamingSourcesResponse.StreamingSources = make([]StreamingSource, 0)
	}
	*o = SearchStreamingSourcesResponse(rawSearchStreamingSourcesResponse)
	return nil
}

func (o SearchStreamingSourcesResponse) MarshalYAML() (interface{}, error) {
	jsonBytes, err := safejson.Marshal(o)
	if err != nil {
		return nil, err
	}
...
func (o *SearchStreamingSourcesResponse) UnmarshalYAML(unmarshal func(interface{}) error) error {
	jsonBytes, err := safeyaml.UnmarshalerToJSONBytes(unmarshal)
	if err != nil {
		return err
	}
...
// Public view of a streaming ingest session.
type StreamingSession struct {
	...
	PointsCount safelong.SafeLong       `json:"pointsCount"`
	CreatedAt   api.Timestamp           `json:"createdAt" safelogging:"@Safe"`
	// Time of the most recent heartbeat for this session.
	LastSeenAt api.Timestamp `json:"lastSeenAt" safelogging:"@Safe"`
	// Time the session was completed. Absent while the session is in progress.
	ClosedAt *api.Timestamp `json:"closedAt,omitempty"`
}

func (o StreamingSession) MarshalYAML() (interface{}, error) {
	jsonBytes, err := safejson.Marshal(o)
	if err != nil {
		return nil, err
	}
...
func (o *StreamingSession) UnmarshalYAML(unmarshal func(interface{}) error) error {
	jsonBytes, err := safeyaml.UnmarshalerToJSONBytes(unmarshal)
	if err != nil {
		return err
	}
...
type StreamingSessionSortOptions struct {
	IsDescending bool                    `json:"isDescending"`
	SortKey      StreamingSessionSortKey `json:"sortKey"`
}

func (o StreamingSessionSortOptions) MarshalYAML() (interface{}, error) {
	jsonBytes, err := safejson.Marshal(o)
	if err != nil {
		return nil, err
	}
...
func (o *StreamingSessionSortOptions) UnmarshalYAML(unmarshal func(interface{}) error) error {
	jsonBytes, err := safeyaml.UnmarshalerToJSONBytes(unmarshal)
	if err != nil {
		return err
	}
...
/*
Matches sessions whose data bounds overlap this window. Sessions with no data bounds do
not match. If both bounds are present, `start` must not be after `end`.
*/
type StreamingSessionTimeRangeFilter struct {
	Start *api.Timestamp `json:"start,omitempty"`
	End   *api.Timestamp `json:"end,omitempty"`
}

func (o StreamingSessionTimeRangeFilter) MarshalYAML() (interface{}, error) {
	jsonBytes, err := safejson.Marshal(o)
	if err != nil {
		return nil, err
	}
...
func (o *StreamingSessionTimeRangeFilter) UnmarshalYAML(unmarshal func(interface{}) error) error {
	jsonBytes, err := safeyaml.UnmarshalerToJSONBytes(unmarshal)
	if err != nil {
		return err
	}
...
type StreamingSource struct {
	...
	SessionCount safelong.SafeLong `json:"sessionCount"`
	// Sum of the points counts across the aggregated sessions.
	TotalPointsCount safelong.SafeLong `json:"totalPointsCount"`
	// Creation time of the oldest aggregated session.
	EarliestCreatedAt api.Timestamp `json:"earliestCreatedAt" safelogging:"@Safe"`
	// Most recent heartbeat time across the aggregated sessions.
	LatestLastSeenAt api.Timestamp `json:"latestLastSeenAt" safelogging:"@Safe"`
	// Union of the data bounds across the aggregated sessions, if any session has bounds.
	MergedBounds *api.Range `json:"mergedBounds,omitempty"`
	// True if at least one aggregated session is in progress.
	AnyInProgress bool `json:"anyInProgress"`
}

func (o StreamingSource) MarshalYAML() (interface{}, error) {
	jsonBytes, err := safejson.Marshal(o)
	if err != nil {
		return nil, err
	}
...
func (o *StreamingSource) UnmarshalYAML(unmarshal func(interface{}) error) error {
	jsonBytes, err := safeyaml.UnmarshalerToJSONBytes(unmarshal)
	if err != nil {
		return err
	}
...
/*
Matches the sessions of a single streaming source: the sessions on `datasetRid` with
exactly the given `source` attribution. An absent `source` matches unattributed sessions.
*/
type StreamingSourceFilter struct {
	DatasetRid rids.DatasetRid         `json:"datasetRid" safelogging:"@Safe"`
	Source     *StreamingSessionSource `json:"source,omitempty"`
}

func (o StreamingSourceFilter) MarshalYAML() (interface{}, error) {
	jsonBytes, err := safejson.Marshal(o)
	if err != nil {
		return nil, err
	}
...
func (o *StreamingSourceFilter) UnmarshalYAML(unmarshal func(interface{}) error) error {
	jsonBytes, err := safeyaml.UnmarshalerToJSONBytes(unmarshal)
	if err != nil {
		return err
	}
...
type UserAndPasswordAuthentication struct {
	...
	PasswordSecretRid api5.SecretRid `json:"passwordSecretRid" safelogging:"@Safe"`
}
...
type VideoOpts struct {
	...
	TimestampManifest api6.VideoFileTimestampManifest `json:"timestampManifest"`
	/*

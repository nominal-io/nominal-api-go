...
/*
Filter for streaming-session search. An empty `datasetRids` list matches all sessions.
Filters compose with `and`/`or`/`not`.
*/
type StreamingSessionSearchFilter struct {
	typ         string
	datasetRids *[]rids.DatasetRid
	source      *StreamingSourceFilter
	timeRange   *StreamingSessionTimeRangeFilter
	workspace   *rids.WorkspaceRid
	and         *[]StreamingSessionSearchFilter
	or          *[]StreamingSessionSearchFilter
	not         *StreamingSessionSearchFilter
}

type streamingSessionSearchFilterDeserializer struct {
	Type        string                           `json:"type"`
	DatasetRids *[]rids.DatasetRid               `json:"datasetRids"`
	Source      *StreamingSourceFilter           `json:"source"`
	TimeRange   *StreamingSessionTimeRangeFilter `json:"timeRange"`
	Workspace   *rids.WorkspaceRid               `json:"workspace"`
	And         *[]StreamingSessionSearchFilter  `json:"and"`
	Or          *[]StreamingSessionSearchFilter  `json:"or"`
	Not         *StreamingSessionSearchFilter    `json:"not"`
}

func (u *streamingSessionSearchFilterDeserializer) toStruct() StreamingSessionSearchFilter {
	return StreamingSessionSearchFilter{typ: u.Type, datasetRids: u.DatasetRids, source: u.Source, timeRange: u.TimeRange, workspace: u.Workspace, and: u.And, or: u.Or, not: u.Not}
}

func (u *StreamingSessionSearchFilter) toSerializer() (interface{}, error) {
	switch u.typ {
	default:
		return nil, fmt.Errorf("unknown type %q", u.typ)
	case "datasetRids":
...
func (u StreamingSessionSearchFilter) MarshalJSON() ([]byte, error) {
	ser, err := u.toSerializer()
	if err != nil {
		return nil, err
	}
...
func (u *StreamingSessionSearchFilter) UnmarshalJSON(data []byte) error {
	var deser streamingSessionSearchFilterDeserializer
	if err := safejson.Unmarshal(data, &deser); err != nil {
		return err
	}
	*u = deser.toStruct()
...
func (u StreamingSessionSearchFilter) MarshalYAML() (interface{}, error) {
	jsonBytes, err := safejson.Marshal(u)
	if err != nil {
		return nil, err
	}
...
func (u *StreamingSessionSearchFilter) UnmarshalYAML(unmarshal func(interface{}) error) error {
	jsonBytes, err := safeyaml.UnmarshalerToJSONBytes(unmarshal)
	if err != nil {
		return err
	}
...
func (u *StreamingSessionSearchFilter) AcceptFuncs(datasetRidsFunc func([]rids.DatasetRid) error, sourceFunc func(StreamingSourceFilter) error, timeRangeFunc func(StreamingSessionTimeRangeFilter) error, workspaceFunc func(rids.WorkspaceRid) error, andFunc func([]StreamingSessionSearchFilter) error, orFunc func([]StreamingSessionSearchFilter) error, notFunc func(StreamingSessionSearchFilter) error, unknownFunc func(string) error) error {
	switch u.typ {
	default:
		if u.typ == "" {
			return fmt.Errorf("invalid value in StreamingSessionSearchFilter type")
		}
		return unknownFunc(u.typ)
	case "datasetRids":
		if u.datasetRids == nil {
...
func (u *StreamingSessionSearchFilter) DatasetRidsNoopSuccess(_ []rids.DatasetRid) error {
	return nil
}

func (u *StreamingSessionSearchFilter) SourceNoopSuccess(_ StreamingSourceFilter) error {
	return nil
}

func (u *StreamingSessionSearchFilter) TimeRangeNoopSuccess(_ StreamingSessionTimeRangeFilter) error {
	return nil
}

func (u *StreamingSessionSearchFilter) WorkspaceNoopSuccess(_ rids.WorkspaceRid) error {
	return nil
}

func (u *StreamingSessionSearchFilter) AndNoopSuccess(_ []StreamingSessionSearchFilter) error {
	return nil
}

func (u *StreamingSessionSearchFilter) OrNoopSuccess(_ []StreamingSessionSearchFilter) error {
	return nil
}

func (u *StreamingSessionSearchFilter) NotNoopSuccess(_ StreamingSessionSearchFilter) error {
	return nil
}

func (u *StreamingSessionSearchFilter) ErrorOnUnknown(typeName string) error {
	return fmt.Errorf("invalid value in union type. Type name: %s", typeName)
}

func (u *StreamingSessionSearchFilter) Accept(v StreamingSessionSearchFilterVisitor) error {
	switch u.typ {
	default:
		if u.typ == "" {
			return fmt.Errorf("invalid value in union type")
...
type StreamingSessionSearchFilterVisitor interface {
	VisitDatasetRids(v []rids.DatasetRid) error
	VisitSource(v StreamingSourceFilter) error
	VisitTimeRange(v StreamingSessionTimeRangeFilter) error
	VisitWorkspace(v rids.WorkspaceRid) error
	VisitAnd(v []StreamingSessionSearchFilter) error
	VisitOr(v []StreamingSessionSearchFilter) error
	VisitNot(v StreamingSessionSearchFilter) error
	VisitUnknown(typeName string) error
}

func (u *StreamingSessionSearchFilter) AcceptWithContext(ctx context.Context, v StreamingSessionSearchFilterVisitorWithContext) error {
	switch u.typ {
	default:
		if u.typ == "" {
			return fmt.Errorf("invalid value in union type")
...
type StreamingSessionSearchFilterVisitorWithContext interface {
	VisitDatasetRidsWithContext(ctx context.Context, v []rids.DatasetRid) error
	VisitSourceWithContext(ctx context.Context, v StreamingSourceFilter) error
	VisitTimeRangeWithContext(ctx context.Context, v StreamingSessionTimeRangeFilter) error
	VisitWorkspaceWithContext(ctx context.Context, v rids.WorkspaceRid) error
	VisitAndWithContext(ctx context.Context, v []StreamingSessionSearchFilter) error
	VisitOrWithContext(ctx context.Context, v []StreamingSessionSearchFilter) error
	VisitNotWithContext(ctx context.Context, v StreamingSessionSearchFilter) error
	VisitUnknownWithContext(ctx context.Context, typeName string) error
}

func NewStreamingSessionSearchFilterFromDatasetRids(v []rids.DatasetRid) StreamingSessionSearchFilter {
	return StreamingSessionSearchFilter{typ: "datasetRids", datasetRids: &v}
}

func NewStreamingSessionSearchFilterFromSource(v StreamingSourceFilter) StreamingSessionSearchFilter {
	return StreamingSessionSearchFilter{typ: "source", source: &v}
}

func NewStreamingSessionSearchFilterFromTimeRange(v StreamingSessionTimeRangeFilter) StreamingSessionSearchFilter {
	return StreamingSessionSearchFilter{typ: "timeRange", timeRange: &v}
}

func NewStreamingSessionSearchFilterFromWorkspace(v rids.WorkspaceRid) StreamingSessionSearchFilter {
	return StreamingSessionSearchFilter{typ: "workspace", workspace: &v}
}

func NewStreamingSessionSearchFilterFromAnd(v []StreamingSessionSearchFilter) StreamingSessionSearchFilter {
	return StreamingSessionSearchFilter{typ: "and", and: &v}
}

func NewStreamingSessionSearchFilterFromOr(v []StreamingSessionSearchFilter) StreamingSessionSearchFilter {
	return StreamingSessionSearchFilter{typ: "or", or: &v}
}

func NewStreamingSessionSearchFilterFromNot(v StreamingSessionSearchFilter) StreamingSessionSearchFilter {
	return StreamingSessionSearchFilter{typ: "not", not: &v}
}
...
/*
Filter for streaming-source search. An empty `datasetRids` list matches all sources.
Filters compose with `and`/`or`/`not`.
*/
type StreamingSourceSearchFilter struct {
	typ         string
	datasetRids *[]rids.DatasetRid
	source      *StreamingSourceFilter
	workspace   *rids.WorkspaceRid
	and         *[]StreamingSourceSearchFilter
	or          *[]StreamingSourceSearchFilter
	not         *StreamingSourceSearchFilter
}

type streamingSourceSearchFilterDeserializer struct {
	Type        string                         `json:"type"`
	DatasetRids *[]rids.DatasetRid             `json:"datasetRids"`
	Source      *StreamingSourceFilter         `json:"source"`
	Workspace   *rids.WorkspaceRid             `json:"workspace"`
	And         *[]StreamingSourceSearchFilter `json:"and"`
	Or          *[]StreamingSourceSearchFilter `json:"or"`
	Not         *StreamingSourceSearchFilter   `json:"not"`
}

func (u *streamingSourceSearchFilterDeserializer) toStruct() StreamingSourceSearchFilter {
	return StreamingSourceSearchFilter{typ: u.Type, datasetRids: u.DatasetRids, source: u.Source, workspace: u.Workspace, and: u.And, or: u.Or, not: u.Not}
}

func (u *StreamingSourceSearchFilter) toSerializer() (interface{}, error) {
	switch u.typ {
	default:
		return nil, fmt.Errorf("unknown type %q", u.typ)
	case "datasetRids":
...
func (u StreamingSourceSearchFilter) MarshalJSON() ([]byte, error) {
	ser, err := u.toSerializer()
	if err != nil {
		return nil, err
	}
...
func (u *StreamingSourceSearchFilter) UnmarshalJSON(data []byte) error {
	var deser streamingSourceSearchFilterDeserializer
	if err := safejson.Unmarshal(data, &deser); err != nil {
		return err
	}
	*u = deser.toStruct()
...
func (u StreamingSourceSearchFilter) MarshalYAML() (interface{}, error) {
	jsonBytes, err := safejson.Marshal(u)
	if err != nil {
		return nil, err
	}
...
func (u *StreamingSourceSearchFilter) UnmarshalYAML(unmarshal func(interface{}) error) error {
	jsonBytes, err := safeyaml.UnmarshalerToJSONBytes(unmarshal)
	if err != nil {
		return err
	}
...
func (u *StreamingSourceSearchFilter) AcceptFuncs(datasetRidsFunc func([]rids.DatasetRid) error, sourceFunc func(StreamingSourceFilter) error, workspaceFunc func(rids.WorkspaceRid) error, andFunc func([]StreamingSourceSearchFilter) error, orFunc func([]StreamingSourceSearchFilter) error, notFunc func(StreamingSourceSearchFilter) error, unknownFunc func(string) error) error {
	switch u.typ {
	default:
		if u.typ == "" {
			return fmt.Errorf("invalid value in StreamingSourceSearchFilter type")
		}
		return unknownFunc(u.typ)
	case "datasetRids":
		if u.datasetRids == nil {
...
func (u *StreamingSourceSearchFilter) DatasetRidsNoopSuccess(_ []rids.DatasetRid) error {
	return nil
}

func (u *StreamingSourceSearchFilter) SourceNoopSuccess(_ StreamingSourceFilter) error {
	return nil
}

func (u *StreamingSourceSearchFilter) WorkspaceNoopSuccess(_ rids.WorkspaceRid) error {
	return nil
}

func (u *StreamingSourceSearchFilter) AndNoopSuccess(_ []StreamingSourceSearchFilter) error {
	return nil
}

func (u *StreamingSourceSearchFilter) OrNoopSuccess(_ []StreamingSourceSearchFilter) error {
	return nil
}

func (u *StreamingSourceSearchFilter) NotNoopSuccess(_ StreamingSourceSearchFilter) error {
	return nil
}

func (u *StreamingSourceSearchFilter) ErrorOnUnknown(typeName string) error {
	return fmt.Errorf("invalid value in union type. Type name: %s", typeName)
}

func (u *StreamingSourceSearchFilter) Accept(v StreamingSourceSearchFilterVisitor) error {
	switch u.typ {
	default:
		if u.typ == "" {
			return fmt.Errorf("invalid value in union type")
...
type StreamingSourceSearchFilterVisitor interface {
	VisitDatasetRids(v []rids.DatasetRid) error
	VisitSource(v StreamingSourceFilter) error
	VisitWorkspace(v rids.WorkspaceRid) error
	VisitAnd(v []StreamingSourceSearchFilter) error
	VisitOr(v []StreamingSourceSearchFilter) error
	VisitNot(v StreamingSourceSearchFilter) error
	VisitUnknown(typeName string) error
}

func (u *StreamingSourceSearchFilter) AcceptWithContext(ctx context.Context, v StreamingSourceSearchFilterVisitorWithContext) error {
	switch u.typ {
	default:
		if u.typ == "" {
			return fmt.Errorf("invalid value in union type")
...
type StreamingSourceSearchFilterVisitorWithContext interface {
	VisitDatasetRidsWithContext(ctx context.Context, v []rids.DatasetRid) error
	VisitSourceWithContext(ctx context.Context, v StreamingSourceFilter) error
	VisitWorkspaceWithContext(ctx context.Context, v rids.WorkspaceRid) error
	VisitAndWithContext(ctx context.Context, v []StreamingSourceSearchFilter) error
	VisitOrWithContext(ctx context.Context, v []StreamingSourceSearchFilter) error
	VisitNotWithContext(ctx context.Context, v StreamingSourceSearchFilter) error
	VisitUnknownWithContext(ctx context.Context, typeName string) error
}

func NewStreamingSourceSearchFilterFromDatasetRids(v []rids.DatasetRid) StreamingSourceSearchFilter {
	return StreamingSourceSearchFilter{typ: "datasetRids", datasetRids: &v}
}

func NewStreamingSourceSearchFilterFromSource(v StreamingSourceFilter) StreamingSourceSearchFilter {
	return StreamingSourceSearchFilter{typ: "source", source: &v}
}

func NewStreamingSourceSearchFilterFromWorkspace(v rids.WorkspaceRid) StreamingSourceSearchFilter {
	return StreamingSourceSearchFilter{typ: "workspace", workspace: &v}
}

func NewStreamingSourceSearchFilterFromAnd(v []StreamingSourceSearchFilter) StreamingSourceSearchFilter {
	return StreamingSourceSearchFilter{typ: "and", and: &v}
}

func NewStreamingSourceSearchFilterFromOr(v []StreamingSourceSearchFilter) StreamingSourceSearchFilter {
	return StreamingSourceSearchFilter{typ: "or", or: &v}
}

func NewStreamingSourceSearchFilterFromNot(v StreamingSourceSearchFilter) StreamingSourceSearchFilter {
	return StreamingSourceSearchFilter{typ: "not", not: &v}
}

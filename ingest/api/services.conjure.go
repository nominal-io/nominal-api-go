...
type StreamingSessionServiceClient interface {
	...
	SearchStreamingSessions(ctx context.Context, authHeader bearertoken.Token, requestArg SearchStreamingSessionsRequest) (SearchStreamingSessionsResponse, error)
	/*
	   Returns a paginated list of streaming sessions aggregated by (source, dataset) group,
	   ordered by latest activity descending.
	*/
	SearchStreamingSources(ctx context.Context, authHeader bearertoken.Token, requestArg SearchStreamingSourcesRequest) (SearchStreamingSourcesResponse, error)
}
...
func (c *streamingSessionServiceClient) SearchStreamingSessions(ctx context.Context, authHeader bearertoken.Token, requestArg SearchStreamingSessionsRequest) (SearchStreamingSessionsResponse, error) {
	var returnVal *SearchStreamingSessionsResponse
	var requestParams []httpclient.RequestParam
	requestParams = append(requestParams, httpclient.WithRPCMethodName("SearchStreamingSessions"))
	requestParams = append(requestParams, httpclient.WithHeader("Authorization", fmt.Sprint("Bearer ", authHeader)))
	requestParams = append(requestParams, httpclient.WithPathf("/ingest/v1/streaming-sessions/search"))
	requestParams = append(requestParams, httpclient.WithJSONRequest(requestArg))
	requestParams = append(requestParams, httpclient.WithJSONResponse(&returnVal))
	requestParams = append(requestParams, httpclient.WithRequestConjureErrorDecoder(conjureerrors.Decoder()))
	if _, err := c.client.Post(ctx, requestParams...); err != nil {
		return *new(SearchStreamingSessionsResponse), werror.WrapWithContextParams(ctx, err, "searchStreamingSessions failed")
	}
	if returnVal == nil {
		return *new(SearchStreamingSessionsResponse), werror.ErrorWithContextParams(ctx, "searchStreamingSessions response cannot be nil")
	}
	return *returnVal, nil
}

func (c *streamingSessionServiceClient) SearchStreamingSources(ctx context.Context, authHeader bearertoken.Token, requestArg SearchStreamingSourcesRequest) (SearchStreamingSourcesResponse, error) {
	var returnVal *SearchStreamingSourcesResponse
	var requestParams []httpclient.RequestParam
	requestParams = append(requestParams, httpclient.WithRPCMethodName("SearchStreamingSources"))
	requestParams = append(requestParams, httpclient.WithHeader("Authorization", fmt.Sprint("Bearer ", authHeader)))
	requestParams = append(requestParams, httpclient.WithPathf("/ingest/v1/streaming-sources/search"))
	requestParams = append(requestParams, httpclient.WithJSONRequest(requestArg))
	requestParams = append(requestParams, httpclient.WithJSONResponse(&returnVal))
	requestParams = append(requestParams, httpclient.WithRequestConjureErrorDecoder(conjureerrors.Decoder()))
	if _, err := c.client.Post(ctx, requestParams...); err != nil {
		return *new(SearchStreamingSourcesResponse), werror.WrapWithContextParams(ctx, err, "searchStreamingSources failed")
	}
	if returnVal == nil {
		return *new(SearchStreamingSourcesResponse), werror.ErrorWithContextParams(ctx, "searchStreamingSources response cannot be nil")
	}
	return *returnVal, nil
}
...
type StreamingSessionServiceClientWithAuth interface {
	...
	// Returns a paginated list of streaming sessions, optionally filtered by dataset.
	SearchStreamingSessions(ctx context.Context, requestArg SearchStreamingSessionsRequest) (SearchStreamingSessionsResponse, error)
	/*
	   Returns a paginated list of streaming sessions aggregated by (source, dataset) group,
	   ordered by latest activity descending.
	*/
	SearchStreamingSources(ctx context.Context, requestArg SearchStreamingSourcesRequest) (SearchStreamingSourcesResponse, error)
}
...
func (c *streamingSessionServiceClientWithAuth) SearchStreamingSessions(ctx context.Context, requestArg SearchStreamingSessionsRequest) (SearchStreamingSessionsResponse, error) {
	return c.client.SearchStreamingSessions(ctx, c.authHeader, requestArg)
}

func (c *streamingSessionServiceClientWithAuth) SearchStreamingSources(ctx context.Context, requestArg SearchStreamingSourcesRequest) (SearchStreamingSourcesResponse, error) {
	return c.client.SearchStreamingSources(ctx, c.authHeader, requestArg)
}
...
func (c *streamingSessionServiceClientWithTokenProvider) SearchStreamingSessions(ctx context.Context, requestArg SearchStreamingSessionsRequest) (SearchStreamingSessionsResponse, error) {
	token, err := c.tokenProvider(ctx)
	if err != nil {
		return *new(SearchStreamingSessionsResponse), err
	}
	return c.client.SearchStreamingSessions(ctx, bearertoken.Token(token), requestArg)
}

func (c *streamingSessionServiceClientWithTokenProvider) SearchStreamingSources(ctx context.Context, requestArg SearchStreamingSourcesRequest) (SearchStreamingSourcesResponse, error) {
	token, err := c.tokenProvider(ctx)
	if err != nil {
		return *new(SearchStreamingSourcesResponse), err
	}
	return c.client.SearchStreamingSources(ctx, bearertoken.Token(token), requestArg)
}

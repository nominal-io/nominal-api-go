...
type StreamingSessionSearchFilterWithT[T any] StreamingSessionSearchFilter

func (u *StreamingSessionSearchFilterWithT[T]) Accept(ctx context.Context, v StreamingSessionSearchFilterVisitorWithT[T]) (T, error) {
	var result T
	switch u.typ {
	default:
		if u.typ == "" {
...
func (u *StreamingSessionSearchFilterWithT[T]) AcceptFuncs(datasetRidsFunc func([]rids.DatasetRid) (T, error), sourceFunc func(StreamingSourceFilter) (T, error), timeRangeFunc func(StreamingSessionTimeRangeFilter) (T, error), workspaceFunc func(rids.WorkspaceRid) (T, error), andFunc func([]StreamingSessionSearchFilter) (T, error), orFunc func([]StreamingSessionSearchFilter) (T, error), notFunc func(StreamingSessionSearchFilter) (T, error), unknownFunc func(string) (T, error)) (T, error) {
	var result T
	switch u.typ {
	default:
		if u.typ == "" {
...
func (u *StreamingSessionSearchFilterWithT[T]) DatasetRidsNoopSuccess([]rids.DatasetRid) (T, error) {
	var result T
	return result, nil
}

func (u *StreamingSessionSearchFilterWithT[T]) SourceNoopSuccess(StreamingSourceFilter) (T, error) {
	var result T
	return result, nil
}

func (u *StreamingSessionSearchFilterWithT[T]) TimeRangeNoopSuccess(StreamingSessionTimeRangeFilter) (T, error) {
	var result T
	return result, nil
}

func (u *StreamingSessionSearchFilterWithT[T]) WorkspaceNoopSuccess(rids.WorkspaceRid) (T, error) {
	var result T
	return result, nil
}

func (u *StreamingSessionSearchFilterWithT[T]) AndNoopSuccess([]StreamingSessionSearchFilter) (T, error) {
	var result T
	return result, nil
}

func (u *StreamingSessionSearchFilterWithT[T]) OrNoopSuccess([]StreamingSessionSearchFilter) (T, error) {
	var result T
	return result, nil
}

func (u *StreamingSessionSearchFilterWithT[T]) NotNoopSuccess(StreamingSessionSearchFilter) (T, error) {
	var result T
	return result, nil
}

func (u *StreamingSessionSearchFilterWithT[T]) ErrorOnUnknown(typeName string) (T, error) {
	var result T
	return result, fmt.Errorf("invalid value in union type. Type name: %s", typeName)
}

type StreamingSessionSearchFilterVisitorWithT[T any] interface {
	VisitDatasetRids(ctx context.Context, v []rids.DatasetRid) (T, error)
	VisitSource(ctx context.Context, v StreamingSourceFilter) (T, error)
	VisitTimeRange(ctx context.Context, v StreamingSessionTimeRangeFilter) (T, error)
	VisitWorkspace(ctx context.Context, v rids.WorkspaceRid) (T, error)
	VisitAnd(ctx context.Context, v []StreamingSessionSearchFilter) (T, error)
	VisitOr(ctx context.Context, v []StreamingSessionSearchFilter) (T, error)
	VisitNot(ctx context.Context, v StreamingSessionSearchFilter) (T, error)
	VisitUnknown(ctx context.Context, typ string) (T, error)
}
...
type StreamingSourceSearchFilterWithT[T any] StreamingSourceSearchFilter

func (u *StreamingSourceSearchFilterWithT[T]) Accept(ctx context.Context, v StreamingSourceSearchFilterVisitorWithT[T]) (T, error) {
	var result T
	switch u.typ {
	default:
		if u.typ == "" {
...
func (u *StreamingSourceSearchFilterWithT[T]) AcceptFuncs(datasetRidsFunc func([]rids.DatasetRid) (T, error), sourceFunc func(StreamingSourceFilter) (T, error), workspaceFunc func(rids.WorkspaceRid) (T, error), andFunc func([]StreamingSourceSearchFilter) (T, error), orFunc func([]StreamingSourceSearchFilter) (T, error), notFunc func(StreamingSourceSearchFilter) (T, error), unknownFunc func(string) (T, error)) (T, error) {
	var result T
	switch u.typ {
	default:
		if u.typ == "" {
...
func (u *StreamingSourceSearchFilterWithT[T]) DatasetRidsNoopSuccess([]rids.DatasetRid) (T, error) {
	var result T
	return result, nil
}

func (u *StreamingSourceSearchFilterWithT[T]) SourceNoopSuccess(StreamingSourceFilter) (T, error) {
	var result T
	return result, nil
}

func (u *StreamingSourceSearchFilterWithT[T]) WorkspaceNoopSuccess(rids.WorkspaceRid) (T, error) {
	var result T
	return result, nil
}

func (u *StreamingSourceSearchFilterWithT[T]) AndNoopSuccess([]StreamingSourceSearchFilter) (T, error) {
	var result T
	return result, nil
}

func (u *StreamingSourceSearchFilterWithT[T]) OrNoopSuccess([]StreamingSourceSearchFilter) (T, error) {
	var result T
	return result, nil
}

func (u *StreamingSourceSearchFilterWithT[T]) NotNoopSuccess(StreamingSourceSearchFilter) (T, error) {
	var result T
	return result, nil
}

func (u *StreamingSourceSearchFilterWithT[T]) ErrorOnUnknown(typeName string) (T, error) {
	var result T
	return result, fmt.Errorf("invalid value in union type. Type name: %s", typeName)
}

type StreamingSourceSearchFilterVisitorWithT[T any] interface {
	VisitDatasetRids(ctx context.Context, v []rids.DatasetRid) (T, error)
	VisitSource(ctx context.Context, v StreamingSourceFilter) (T, error)
	VisitWorkspace(ctx context.Context, v rids.WorkspaceRid) (T, error)
	VisitAnd(ctx context.Context, v []StreamingSourceSearchFilter) (T, error)
	VisitOr(ctx context.Context, v []StreamingSourceSearchFilter) (T, error)
	VisitNot(ctx context.Context, v StreamingSourceSearchFilter) (T, error)
	VisitUnknown(ctx context.Context, typ string) (T, error)
}

...
type ManifestOutput struct {
	...
	*/
	...
	// Unit per channel, keyed by channel name after channelPrefix is applied.
	Units map[api.Channel]api.Unit `json:"units"`
}
...
func (o ManifestOutput) MarshalJSON() ([]byte, error) {
	...
	if o.Units == nil {
		o.Units = make(map[api.Channel]api.Unit)
	}
...
func (o *ManifestOutput) UnmarshalJSON(data []byte) error {
	...
	if rawManifestOutput.Units == nil {
		rawManifestOutput.Units = make(map[api.Channel]api.Unit)
	}
